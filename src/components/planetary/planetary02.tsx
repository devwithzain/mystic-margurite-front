import { MovingInFull, plan02 } from "@/assets";
import { MediaPlayer, TextMask } from "@/components";
import AnimatedText from "@/components/animated-text";

export default function Planetary02() {
	return (
		<div className="w-full padding-y padding-x">
			<div className="flex items-center justify-center flex-col gap-10">
				<MediaPlayer src={MovingInFull} />
				<div className="">
					<AnimatedText
						text="Meditation on the Mercury"
					...
					<div className="w-full flex items-center justify-center gap-10">
						...
						<div className="flex-1 flex flex-col gap-5">
							...
							<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								<TextMask>
									{[
										"Gemini rules the natural third house of the zodiac, concerned with one-on-one relationships and the gathering of information; then comparing or contrasting the meaning and values associated with them",
									]}
								</TextMask>
							</p>
						</div>
