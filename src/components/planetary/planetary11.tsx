import { plan11, SlipperyEdgeFull } from "@/assets";
	...
	return (
		<div className="w-full padding-y padding-x">
			<div className="flex items-center justify-center flex-col gap-10">
				<MediaPlayer src={SlipperyEdgeFull} />
				<div className="">
					<AnimatedText
				...
				<div className="w-full flex items-center gap-10 flex-col">
					<div className="w-full flex items-center justify-center gap-10">
						...
						<div className="flex-1 flex flex-col gap-5">
							...
							<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								<TextMask>
									{[
										"By mass and diameter, Pluto and its companion Moon Charon are not even considered a planet any more; its status has been reduced to planetoid but this demotion by a handfull of astronomers has corresponded with a social imperative that seeks to essentially trivialize death, as we move ever closer to an environmental reckoning and nucs held loosely in the hands of maniacs.",
									]}
								</TextMask>
							</p>
						</div>
					...
					<div className="flex flex-col gap-4">
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							<TextMask>
								{[
									"Haven't we been subjected to increasing doses of gratitous violence and hopelessness through the media: are you numb enough yet? Astrologically the impact of Pluto's field of resonance on human affairs when in heavy aspect to another planet cannot be missed. As with the other outer planets, it was first believed that Pluto's tracks were reflected mainly in large-scale events of destiny involving the masses. To that end, it represents transformation and resurrection at the highest level, degradation and annihilation at the lowest. Both violent mob mentality and the social evolutionary path to greatness lie in Pluto's domain.",
								]}
							</TextMask>
						</p>
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
						...
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							<TextMask>
								{[
									'The phrase "being led to the burning field" applies to a visit from Pluto. There can be loss or gain of great power and prestige in career; or perhaps one or more powerful persons will appear, who get in close to make or break you, maybe take chunks your very soul. The energy can take the form of a health issue-your own or somebody elses for whom you are responsible-which alters your sense of freedom and autonomy forever. Perhaps the visit is experienced as the progressive dismantling of ones own emotional or spiritual structures, the loss of every neat definition, category and ritual a person has developed in order to make sense of their reality and conduct the business of existence.',
								]}
							</TextMask>
						</p>
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
