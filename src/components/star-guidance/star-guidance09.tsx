import { guide09 } from "@/assets";
import { TextMask } from "@/components";
import RoundButton from "../round-button";
import AnimatedText from "@/components/animated-text";

export default function StarGuidance09() {
	return (
		<div className="w-full padding-y padding-x">
			<div className="flex items-center justify-center flex-col gap-10">
				<div className="">
					<AnimatedText
						text="Past Lives-Future Path"
				...
				<div className="w-full flex items-center gap-10 flex-col">
					<div className="w-full flex items-center justify-center gap-10">
						...
						<div className="flex-1 flex flex-col gap-5">
							<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								<TextMask>
									{[
										"The Nodes as defined in astronomy are the points of intersection between a planet's orbit and the ecliptic, or apparent path of the Sun around the Earth. The Moon's South Node is the point where the Moon crosses the ecliptic on its way to the southernmost span of orbit,	",
									]}
								</TextMask>
							</p>
							<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
					...
					<div className="flex flex-col gap-4">
						...
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							<TextMask>
								{[
									"If not comfortable with the concept of reincarnation, consider the possibility of traumas and ingrained beliefs formed in early childhood and/or inherited from family ancestors down through several generations, which are stored in the body at mental, instinctive and cellular levels of being and even more troublesome stored in the subtle body energy fields surrounding the body. These patterns continue to be triggered reactively at the unconscious or subconscious level in response to various emotional or environmental cues, whether they are good for us or not. This mechanism is the foundation for the defensive ego and its preference for running on autopilot, even while we declare ourselves to be 'doing what I want'.",
								]}
							</TextMask>
						</p>
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
						...
						<ul className="flex flex-col list-disc list-inside">
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								(1) Pluto: The Evolutionary Journey of the Soul, by Jeff Green,
								Llewellyn Publications, St. Paul, MN, 1996.{" "}
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								(2) Pluto: The Soul's Evolution Through Relationships, by
								Jeffrey Wolf Green, Llwewllyn Publications, St. Paul, MN, 1997.
							</li>
						</ul>
					</div>
				</div>
