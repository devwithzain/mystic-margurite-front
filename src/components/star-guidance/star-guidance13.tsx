import { guide13 } from "@/assets";
import { TextMask } from "@/components";
import AnimatedText from "@/components/animated-text";

export default function StarGuidance13() {
	return (
				...
				<div className="w-full flex items-center gap-10 flex-col">
					<div className="w-full flex items-center justify-center gap-10">
						...
						<div className="flex-1 flex flex-col gap-5">
							...
							<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								<TextMask>
									{[
										"Trinity means many things, but above all encompasses the cycle of birth, life and death as being phases in an eternal dance energised by an eternal creator. This vision of trinity would also support the concept that all of manifestation in nature is equal to and co-existent with spirit in being a divine, eternal exchange between energy and matter. Unfortunately, down through the times of patriarchal culture the number thirteen and much of the sacred symbolism attached to it became an unlucky omen, just as much that was held sacred in Great Mother worship was either demonized or adapted into later religious practice under a different name and function.",
									]}
								</TextMask>
							</p>
						</div>
					...
					<div className="flex flex-col gap-4">
						...
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							<TextMask>
								{[
									"Strangely co-incident with development of the linear alphabet and rising influence of logical-linear left brain dominance, early lunar/stellar cultures gave way about six thousand years ago to the solar/Apollonian principles of Light as embodied in (human) Reason. Correspondingly, earthly existence became dualized into good and evil, mind versus body, word versus image, man versus women, spirit (as identified through mind) versus nature which shaped much of modern civilization including the conduct of war, loss of women's rights, religious persecutions and rampant economic exploitation.",
								]}
							</TextMask>
						</p>
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
						...
						<div className="w-full flex items-start">
							<p className="text-black subHeading font-semibold montserrat leading-loose tracking-normal">
								<TextMask>{["Part II: Moon Phases in Action."]}</TextMask>
							</p>
						</div>
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							<TextMask>
						...
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							<TextMask>
								{[
									"The second quarter phases bring all these considerations to the table, plus adds the pressure of ideals and their expectations. The limiting influences of other people and experiences in interpersonal interaction do much to temper the character and content of one's goals and how they are pursued, or not when disillusion muddys the storyline. For someone born around the Full Moon phase it is important to release one's themes and creations out into the world. We can experience quite a crisis around getting head and heart, intellect and instinct onto the same page; the state of being can be quite dualistic, split between 'in here' and 'out there' is common. Maintaining a permanent relationship can be difficult as one feels options need to be kept open for something better.",
								]}
							</TextMask>
						</p>
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
						...
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							<TextMask>
								{[
									"In the last quarter Moon phases we are brought to another existential crisis, wherein much of that which formerly held great value and importance for the individual no longer matters. Beliefs, preoccupations with power or sex and conformist tendencies that used to define one's universe are no longer as potent; we must go beyond orthodoxy and duty out into the endless planes of spiritual exploration. The very late phases represent lives crafted of endings and beginnings as the soul gets ready to commence a new round of development. Service and sacrifice may be the most evolved way to live with an 'old' Moon, but there are some born into this phase who may have refined the art of being self-involved to a high degree instead. Old Moon folks are frequently very capable at finding sustenance in the world but they are essentially removed from the mundane lifestyle in some way. The very old or Balsamic Moon has the task of balancing any karma and unresolved issues that have not been dealt with before. Just like the New Moon individual, they can be disinclined to form permanent relations with a partner, unless that individual serves as a useful means of support or protection.",
								]}
							</TextMask>
						</p>
						<p className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
						...
						<ul className="flex flex-col gap-2 list-disc list-inside">
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								The birth Moon by house and sign; what does this mean in terms
								of the past, influence of the ancestors and current security
								needs? What sort of person was your mother and how did she
								interact with you? What does the elemental signature and aspects
								made by the Moon say about instinct, intuition, and access to
								the dreamtime and astral realms? What is the nature of the
								emotional body, how are feelings and emotions processed?
								Examples: Moon in Aquarius in the sixth house of unresolved
								issues, health, co-workers, service and small animals. Aquarian
								Moon can use distance and detachment as a security need; in the
								sixth house it can represent one who is shy and alienated from
								others; expressed positively it can point to someone who serves
								in the alternative healing industry. Libra Moon in the second
								house of values, self-esteem and making money; Moon in Libra
								loves to socialize and usually does not favor the rude or crude
								in demeanor; in the second house it can indicate someone who's
								self-esteem is tied to their popularity or who makes their money
								through public relations, the arts or the beauty industry.
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								Aspects made by the Moon to other planets and points in the
								birth chart can be incredibly powerful in shaping the scope,
								themes and challenges of our life. For example: Moon square
								Venus (values, self-esteem, the feminine sexual)can indicate
								conflicts within self identity as a nurturer and "mother" versus
								being a sexual, independent woman; Madonna-whore complex in a
								man. Moon square Mars (aggression,drive,libido)has issues with
								channeling emotions and desires; this energy can express as
								destructive, impulsive anger or focused and determined ambition.
								Moon square Jupiter (expansion, fortune, belief systems,)can be
								boisterous, gregarious and generous or prone to exaggeration and
								over-the-top behavior, even crisis-prone in the direction of
								nervous breakdown or eating disorders.
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								The Moon's Nodes are powerful tools with which to explore both
								who we already are and what we are trying to become. The South
								Node or Dragon's Tail () relates to past lives, where we have
								already been and what we are used to; The North Node or Dragon's
								Head () pertains to the path of soul growth. The position of
								this Node and aspects made to it can be most useful for
								determining what our purpose is for being here in this lfetime.
								Planetary aspects made to the Nodes symbolize character traits
								and family-based dynamics that can help or block our progress
								forward as we mature.
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								Astrologers use a technique called Secondary Progressions to
								learn more about the current emotional tone and focus of
								interest likely for an individual. These progressions are found
								by advancing the positions of the planets about one day for each
								year of life. The progressed Moon is most immediately useful as
								it moves a little over a degree per month, depending on when
								during the year a person is born. The progressed Moon shows
								where we are currently in mental process, what the most
								immediate focus in life is likely to be at any given time;
								progressed Moon can serve as a trigger by aspect for the
								manifestation of major events in life, as we are co-creators in
								determining the course of our experience on the earthly plane.
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								(1) Echoes of the Ancient Skies -The Astronomy of Lost
								Civilizations, by Dr. E.C. Krupp,Harper and Row Publishers, New
								York, NY, 1983.
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								(2) Phases of the Moon, A Guide to Evolving Human Nature, by
								Marilyn Busteed and Dorothy Wergin, AFA, Inc., Tempe, AZ. 1992.
							</li>
						</ul>
					</div>
				</div>
