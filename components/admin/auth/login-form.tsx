	...
	return (
		<div className="w-full px-10 flex justify-center flex-col gap-8">
			<div className="flex flex-col gap-4">
				<h1 className="subHeading text-white font-medium font-gradient-medium leading-tight tracking-tight">
					Welcome back
				</h1>
				<div className="flex items-center gap-2">
					<p className="paragraph text-[#ADABB8] font-normal leading-tight tracking-tight font-gradient-regular">
			...
			<form
						...
						<div className="flex flex-col gap-2">
							<div
								...
								<input
									...
									{...register("email")}
									placeholder="Email"
									className={`bg-transparent text-white placeholder:text-[#6D6980] focus:outline-none outline-none w-full font-gradient-regular paragraph`}
									autoComplete="off"
								/>
							</div>
							{errors.email && (
								<span className="text-red-500 text-sm font-gradient-regular paragraph">
				...
				<button
					...
					className="w-full bg-[#2f1d88] rounded-lg p-4 font-gradient-regular paragraph text-white font-normal text-center leading-tight tracking-tight cursor-pointer">
					{isSubmitting ? (
