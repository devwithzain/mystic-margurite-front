					...
					<div className="w-full flex flex-col gap-10">
						...
						<div className="w-full border-t border-black/20 pt-2">
							...
							<p className="text-black paragraph font-normal montserrat leading-tight tracking-normal">
								...
								Uranus&apos;s influence in astrology represents our need for
								freedom, individuality, and authentic self-expression. It
								challenges us to think differently and embrace change, even when
								it feels uncomfortable. This planet&apos;s energy can be both
								liberating and destabilizing, teaching us that growth often
								comes through disruption of the familiar. Understanding Uranus
								in our charts helps us navigate periods of sudden change and
								harness our innovative potential for personal and collective
								evolution.
							</p>
						</div>
					</div>
