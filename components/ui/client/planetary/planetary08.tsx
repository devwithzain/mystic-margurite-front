					...
					<div className="w-full flex flex-col gap-10">
						...
						<div className="w-full border-t border-black/20 pt-2">
							...
							<p className="text-black paragraph font-normal montserrat leading-tight tracking-normal">
								...
								and responsibility. Saturn&apos;s aspects to other planets
								indicate how we handle authority, structure, and long-term
								commitments. Through Saturn&apos;s influence, we learn to build
								lasting foundations and achieve meaningful accomplishments
								through sustained effort and dedication.
							</p>
						</div>
					</div>
				</div>
