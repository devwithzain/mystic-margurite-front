...
export default function Navbar() {
	...
	return (
		<>
			<motion.nav
				...
				<div className="w-full flex items-center justify-between">
					...
					<div className="flex items-center gap-2">
						<div
							onClick={toggleCart}
							className="bg-[#7a74ef] px-6 py-2.5 relative rounded-lg text-white">
						...
						<Link
							href="/contact-us"
							className="w-fit px-6 py-2.5 bg-[#7a74ef] rounded-lg cursor-pointer text-white paragraph font-normal montserrat">
							Contact Us
						</Link>
						<UserMenu />
					</div>
			...
			<div className="w-full items-center justify-between hidden sm:flex xm:flex fixed top-0 padding-x py-5">
				<div>
					<Link href="/">
						<Image
							src={footerLogo}
