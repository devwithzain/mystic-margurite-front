					...
					<div className="flex flex-col gap-4">
						...
						<ul className="flex flex-col gap-2 list-disc list-inside">
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								...
								in demeanor; in the second house it can indicate someone
								who&apos;s self-esteem is tied to their popularity or who makes
								their money through public relations, the arts or the beauty
								industry.
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							...
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								...
								both who we already are and what we are trying to become. The
								South Node or Dragon&apos;s Tail () relates to past lives, where
								we have already been and what we are used to; The North Node or
								Dragon&apos;s Head () pertains to the path of soul growth. The
								position of this Node and aspects made to it can be most useful
								for determining what our purpose is for being here in this
								lfetime. Planetary aspects made to the Nodes symbolize character
								traits and family-based dynamics that can help or block our
								progress forward as we mature.
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
