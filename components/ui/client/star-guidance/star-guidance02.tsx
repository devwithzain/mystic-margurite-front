					...
					<div className="flex flex-col gap-4">
						...
						<ul className="flex flex-col gap-3 list-disc list-inside">
							...
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								...
								solar return Sun and the Moon&apos;s Nodes. Suppose the return
								Sun is located in the eleventh house; much energy and effort
								will likely be directed into networking, community affairs,
								friends, lovers, fantasies and wishes during the upcoming year.
								The Moon&apos;s Nodes are relationship and status quo
								indicators; for example if placed across the second and eighth
								houses,one will have many interpersonal dealings centered around
								money, investments, assets or debts; also personal values versus
							...
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								...
								spouse isn&apos;t working or a parent needs home care.
								Conversely, one could be kept so busy in public life that hearth
								and home are neglected. Positively, Saturn in the fourth always
								indicates laying new foundations for future success, especially
								as pertains to real estate or business.
							</li>
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
							...
							<li className="text-black paragraph font-normal montserrat leading-loose tracking-normal">
								...
								Moon; this can translate into changes involving the
								native&apos;s mother; a change in residence, status or a change
								in heart that ends a relationship.
							</li>
						</ul>
					</div>
				</div>
